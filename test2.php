<?php
    ...
    echo("1");
        ...
        <input type="hidden" name="idUpdate" value="' . $resultsId[0]['id_user'] . '">
        <br>
        <label for="">Nom</label>
...
echo("4");
        $sqlUpdate = "UPDATE `users` SET `nom_user`='$nomUpdate', `prenom_user`='$prenomUpdate',`age_user`='$ageUpdate',`adresse_mail_user`='$adresseMailUpdate', `password_user`='$hashedPassword' WHERE 
        id_user='$idUpdate'";
